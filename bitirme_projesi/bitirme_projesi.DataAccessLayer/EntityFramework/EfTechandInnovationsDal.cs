...
{
	public class EfTechandInnovationsDal : GenericRepository<TechandInnovation>, ITechandInnovationDal
	{
		public EfTechandInnovationsDal(NewsContext newsContext) : base(newsContext)
		{
		}
	}
}
