...
{
	public class EfLatestArticlesDal : GenericRepository<LatestArticles>, ILatestArticlesDal
	{
		public EfLatestArticlesDal(NewsContext newsContext) : base(newsContext)
		{
		}
	}
}
